<nav class="bg-white border-b border-gray-200">
    <div
        class="max-w-screen-xl xl:p-10 md:max-xl:p-8  max-sm:p-5 flex flex-wrap items-center justify-between mx-auto p-3">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://laravel.com/img/logomark.min.svg" class="h-10" alt="Laravel logo" />
            <span class="text-black text-2xl font-semibold">Larablog</span>
        </a>
